...
namespace CheckOpenXML
{
    public class DocxHelper
    {
        ...
        private int[] InitialCodeArray = { 0xE1F0, 0x1D0F, 0xCC9C, 0x84C0, 0x110C, 0x0E10, 0xF1CE, 0x313E, 0x1872, 0xE139, 0xD40F, 0x84F9, 0x280C, 0xA96A, 0x4EC3 };

        private int[,] EncryptionMatrix = new int[15, 7]
        {
